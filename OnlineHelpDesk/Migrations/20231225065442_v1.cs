        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ticket_Account_SupporterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Discussion_Account",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Discussion_Ticket",
                        column: x => x.TickerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Discussion_AccountId",
                table: "Discussion",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Discussion_TickerId",
                table: "Discussion",
                column: "TickerId");

            migrationBuilder.CreateIndex(
                name: "IX_Photo_TicketId",
                table: "Photo",
                column: "TicketId");
